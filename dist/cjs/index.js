...
var templateObject_1$4, templateObject_2$4, templateObject_3$4, templateObject_4$4, templateObject_5$4, templateObject_6$3, templateObject_7$3, templateObject_8$3, templateObject_9$3, templateObject_10$2, templateObject_11$2;
...
var ButtonStyle = styled__default["default"].button(templateObject_7$2 || (templateObject_7$2 = __makeTemplateObject(["\n\tposition: relative;\n\tdisplay: flex;\n\tjustify-content: center;\n\talign-items: center;\n\theight: 40px;\n\tmin-width: 120px;\n\tmargin: 8px;\n\tborder-radius: 4px;\n\tcolor: ", ";\n\tcursor: pointer;\n\toverflow: hidden;\n\tfont-weight: bold;\n\tpadding: 12px 24px;\n\n\t&:hover {\n\t\topacity: 0.8;\n\t}\n\n\t", "\n\n\t", "\n"], ["\n\tposition: relative;\n\tdisplay: flex;\n\tjustify-content: center;\n\talign-items: center;\n\theight: 40px;\n\tmin-width: 120px;\n\tmargin: 8px;\n\tborder-radius: 4px;\n\tcolor: ", ";\n\tcursor: pointer;\n\toverflow: hidden;\n\tfont-weight: bold;\n\tpadding: 12px 24px;\n\n\t&:hover {\n\t\topacity: 0.8;\n\t}\n\n\t", "\n\n\t", "\n"])), function (props) { var _a, _b; return "".concat((_b = (_a = props.theme.button) === null || _a === void 0 ? void 0 : _a.color) === null || _b === void 0 ? void 0 : _b[props.color]); }, function (props) {
    var _a, _b, _c, _d;
    return (props.variant === 'outlined' && styled.css(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n\t\t\t\tcolor: #000000;\n\t\t\t\tborder: 3px solid ", ";\n\t\t\t\tbackground: none;\n\t\t\t"], ["\n\t\t\t\tcolor: #000000;\n\t\t\t\tborder: 3px solid ", ";\n\t\t\t\tbackground: none;\n\t\t\t"])), (_b = (_a = props.theme.button) === null || _a === void 0 ? void 0 : _a.borderColor) === null || _b === void 0 ? void 0 : _b[props.color])) ||
        (props.variant === 'contained' && styled.css(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n\t\t\t\tborder: none;\n\t\t\t\tbackground: ", ";\n\t\t\t"], ["\n\t\t\t\tborder: none;\n\t\t\t\tbackground: ", ";\n\t\t\t"])), (_d = (_c = props.theme.button) === null || _c === void 0 ? void 0 : _c.backgroundColor) === null || _d === void 0 ? void 0 : _d[props.color])) ||
...
var rippleEffect = styled.keyframes(templateObject_9$2 || (templateObject_9$2 = __makeTemplateObject(["\n\t0% {\n    transform: scale(1);\n    opacity: 1;\n  }\n  50% {\n    transform: scale(10);\n    opacity: 0.375;\n  }\n  100% {\n    transform: scale(35);\n    opacity: 0;\n  }\n"], ["\n\t0% {\n    transform: scale(1);\n    opacity: 1;\n  }\n  50% {\n    transform: scale(10);\n    opacity: 0.375;\n  }\n  100% {\n    transform: scale(35);\n    opacity: 0;\n  }\n"])));
...
var templateObject_1$2, templateObject_2$2, templateObject_3$2, templateObject_4$2, templateObject_5$2, templateObject_6$2, templateObject_7$2, templateObject_8$2, templateObject_9$2, templateObject_10$1, templateObject_11$1, templateObject_12$1, templateObject_13$1, templateObject_14, templateObject_15, templateObject_16, templateObject_17, templateObject_18;
...
var OptionStyle = styled__default["default"].li(templateObject_8$1 || (templateObject_8$1 = __makeTemplateObject(["\n\tcursor: pointer;\n\tpadding: 12px 24px 12px 24px;\n\tmargin: 8px 0px 8px 0px;\n\tfont-weight: 500;\n\t/* height: 1em; */\n\n\t&:hover {\n\t\tbackground-color: ", ";\n\t}\n\n\t", "\n"], ["\n\tcursor: pointer;\n\tpadding: 12px 24px 12px 24px;\n\tmargin: 8px 0px 8px 0px;\n\tfont-weight: 500;\n\t/* height: 1em; */\n\n\t&:hover {\n\t\tbackground-color: ", ";\n\t}\n\n\t", "\n"])), function (props) { return props.disabled ? '#ffffff' : 'rgba(144, 144, 144, 0.3)'; }, function (props) { return props.disabled && styled.css(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n\t\tcursor: default;\n\t\tcolor: rgba(0, 0, 0, 0.5);\n\t"], ["\n\t\tcursor: default;\n\t\tcolor: rgba(0, 0, 0, 0.5);\n\t"]))); });
styled__default["default"](OptionStyle)(templateObject_9$1 || (templateObject_9$1 = __makeTemplateObject(["\n\tcursor: default;\n\tcolor: rgba(0, 0, 0, 0.5);\n\n\t&:hover {\n\t\tbackground-color: #ffffff;\n\t}\n"], ["\n\tcursor: default;\n\tcolor: rgba(0, 0, 0, 0.5);\n\n\t&:hover {\n\t\tbackground-color: #ffffff;\n\t}\n"])));
...
var Select = react.forwardRef(function (props, ref) {
    ...
    var _c = react.useState(false), optionsOpen = _c[0], setOptionsOpen = _c[1];
    ...
    return (jsxRuntime.jsxs(SelectWrapperStyle, __assign({ ref: wrapperRef }, props, { children: [jsxRuntime.jsxs(SelectStyle, __assign({ tabIndex: 0, rotate: showOptions, ref: ref, onFocus: handleSelectFocus, onClick: handleSelectClick }, { children: [jsxRuntime.jsx("span", { children: (selectedOption && selectedOption.label) || placeholder }), jsxRuntime.jsxs("svg", __assign({ xmlns: 'http://www.w3.org/2000/svg', height: '24px', viewBox: '0 0 24 24', width: '24px', fill: '#000000' }, { children: [jsxRuntime.jsx("path", { d: 'M0 0h24v24H0V0z', fill: 'none' }), jsxRuntime.jsx("path", { d: 'M7 10l5 5 5-5H7z' })] }))] })), jsxRuntime.jsx(OptionsWrapperStyle, __assign({ show: showOptions }, { children: jsxRuntime.jsx(OptionsListStyle, { children: options.map(function (option, index) { return (jsxRuntime.jsx(OptionStyle, __assign({ onClick: function () { return handleOptionClick(option); }, value: option.value, disabled: option.disabled }, { children: option.label }), index)); }) }) }))] })));
});
