...
var Dialog = require$$0.forwardRef(function (props, ref) {
    ...
    var dialogRef = require$$0.useRef(null);
...
var Select = require$$0.forwardRef(function (props, ref) {
    ...
    return (jsxRuntime.exports.jsxs(SelectWrapperStyle, __assign({ className: className, style: style, theme: theme }, { children: [jsxRuntime.exports.jsxs(SelectStyle, __assign({ rotate: showOptions, ref: ref, onClick: function () { return setShowOptions(!showOptions); } }, { children: [jsxRuntime.exports.jsx("span", { children: (selectedOption && selectedOption.label) || placeholder }, void 0), jsxRuntime.exports.jsxs("svg", __assign({ xmlns: 'http://www.w3.org/2000/svg', height: '24px', viewBox: '0 0 24 24', width: '24px', fill: '#000000' }, { children: [jsxRuntime.exports.jsx("path", { d: 'M0 0h24v24H0V0z', fill: 'none' }, void 0), jsxRuntime.exports.jsx("path", { d: 'M7 10l5 5 5-5H7z' }, void 0)] }), void 0)] }), void 0), jsxRuntime.exports.jsx(OptionsWrapperStyle, __assign({ show: showOptions }, { children: jsxRuntime.exports.jsx(OptionsListStyle, { children: options.map(function (option, index) { return (jsxRuntime.exports.jsx(OptionStyle, __assign({ onClick: function () { return handleOptionClick(option); }, value: option.value }, { children: option.label }), index)); }) }, void 0) }), void 0)] }), void 0));
});
...
var DropdownItem = require$$0.forwardRef(function (props, ref) {
    ...
    return (jsxRuntime.exports.jsx(DropdownItemStyle, __assign({ onClick: onClick, ref: ref, theme: theme, className: className, style: style }, { children: children }), void 0));
});
...
var Toast = require$$0.forwardRef(function (props, ref) {
    ...
    var _a = require$$0.useState('default'), type = _a[0], setType = _a[1];
