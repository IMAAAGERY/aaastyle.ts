...
var Select = react.forwardRef(function (props, ref) {
    ...
    return (jsxRuntime.jsxs(SelectWrapperStyle, __assign({ className: className, style: style, theme: theme }, { children: [jsxRuntime.jsxs(SelectStyle, __assign({ rotate: showOptions, ref: ref, onClick: function () { return setShowOptions(!showOptions); } }, { children: [jsxRuntime.jsx("span", { children: (selectedOption && selectedOption.label) || placeholder }), jsxRuntime.jsxs("svg", __assign({ xmlns: 'http://www.w3.org/2000/svg', height: '24px', viewBox: '0 0 24 24', width: '24px', fill: '#000000' }, { children: [jsxRuntime.jsx("path", { d: 'M0 0h24v24H0V0z', fill: 'none' }), jsxRuntime.jsx("path", { d: 'M7 10l5 5 5-5H7z' })] }))] })), jsxRuntime.jsx(OptionsWrapperStyle, __assign({ show: showOptions }, { children: jsxRuntime.jsx(OptionsListStyle, { children: options.map(function (option, index) { return (jsxRuntime.jsx(OptionStyle, __assign({ onClick: function () { return handleOptionClick(option); }, value: option.value }, { children: option.label }), index)); }) }) }))] })));
});
