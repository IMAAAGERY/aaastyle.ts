...
import { forwardRef, useEffect, useRef, useState, useId, useImperativeHandle } from 'react';
...
var ButtonContentStyle = styled.span(templateObject_8$2 || (templateObject_8$2 = __makeTemplateObject(["\n\tposition: relative;\n\tdisplay: flex;\n\tjustify-content: center;\n\talign-items: center;\n\tz-index: 2;\n"], ["\n\tposition: relative;\n\tdisplay: flex;\n\tjustify-content: center;\n\talign-items: center;\n\tz-index: 2;\n"])));
var rippleEffect = keyframes(templateObject_9$2 || (templateObject_9$2 = __makeTemplateObject(["\n\t0% {\n    transform: scale(1);\n    opacity: 1;\n  }\n  50% {\n    transform: scale(10);\n    opacity: 0.375;\n  }\n  100% {\n    transform: scale(35);\n    opacity: 0;\n  }\n"], ["\n\t0% {\n    transform: scale(1);\n    opacity: 1;\n  }\n  50% {\n    transform: scale(10);\n    opacity: 0.375;\n  }\n  100% {\n    transform: scale(35);\n    opacity: 0;\n  }\n"])));
...
var Button = forwardRef(function (props, ref) {
    ...
    return (jsxs(ButtonStyle, __assign({ ref: ref }, rest, { onClick: handleClick, variant: variant || 'contained', color: color || 'primary', shape: shape || 'rounded' }, { children: [jsx(ButtonContentStyle, { children: children }), isRippling && jsx(ButtonRippleStyle, { left: coords.x, top: coords.y })] })));
});
...
var OptionStyle = styled.li(templateObject_8$1 || (templateObject_8$1 = __makeTemplateObject(["\n\tcursor: pointer;\n\tpadding: 12px 24px 12px 24px;\n\tmargin: 8px 0px 8px 0px;\n\tfont-weight: 500;\n\t/* height: 1em; */\n\n\t&:hover {\n\t\tbackground-color: ", ";\n\t}\n\n\t", "\n"], ["\n\tcursor: pointer;\n\tpadding: 12px 24px 12px 24px;\n\tmargin: 8px 0px 8px 0px;\n\tfont-weight: 500;\n\t/* height: 1em; */\n\n\t&:hover {\n\t\tbackground-color: ", ";\n\t}\n\n\t", "\n"])), function (props) { return props.disabled ? '#ffffff' : 'rgba(144, 144, 144, 0.3)'; }, function (props) { return props.disabled && css(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n\t\tcursor: default;\n\t\tcolor: rgba(0, 0, 0, 0.5);\n\t"], ["\n\t\tcursor: default;\n\t\tcolor: rgba(0, 0, 0, 0.5);\n\t"]))); });
styled(OptionStyle)(templateObject_9$1 || (templateObject_9$1 = __makeTemplateObject(["\n\tcursor: default;\n\tcolor: rgba(0, 0, 0, 0.5);\n\n\t&:hover {\n\t\tbackground-color: #ffffff;\n\t}\n"], ["\n\tcursor: default;\n\tcolor: rgba(0, 0, 0, 0.5);\n\n\t&:hover {\n\t\tbackground-color: #ffffff;\n\t}\n"])));
